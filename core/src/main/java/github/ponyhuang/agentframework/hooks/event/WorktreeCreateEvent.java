...
/**
 * Event fired when a worktree is created.
 */
public class WorktreeCreateEvent extends BaseEvent {
    ...
    // WorktreeCreate specific properties
    private String name;

    public WorktreeCreateEvent() {
        super(HookEventType.WORKTREE_CREATE);
    }
