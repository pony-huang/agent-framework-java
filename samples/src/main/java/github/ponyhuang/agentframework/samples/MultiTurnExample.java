...
//        if (response1.getLastMessage() != null) {
//            System.out.println("Agent: " + response1.getLastMessage().getTextContent() + "\n");
//        } else {
...
//        if (response2.getLastMessage() != null) {
//            System.out.println("Agent: " + response2.getLastMessage().getTextContent());
//        } else {
//             System.out.println("Agent: [No response text]\n");
//        }
//    }
